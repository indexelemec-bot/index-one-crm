...
export default function Dashboard() {
  ...
  const pipeline = visible.reduce((sum, item) => sum + item.monthlyFee, 0);
  const prioritized = [...visible].sort((a, b) => stageClosingProbability[b.stage] - stageClosingProbability[a.stage] || b.monthlyFee - a.monthlyFee || new Date(a.nextActionAt).getTime() - new Date(b.nextActionAt).getTime());
