...
export const salesSpeeches: SalesSpeech[] = [
  ...
  speech("solucion-dolor", "solucion_recomendada", "Solución vinculada al dolor", "Según el diagnóstico, la prioridad no es simplemente cambiar de administrador; es resolver [Problema]. Recomendamos [Solución] para lograr el resultado esperado. La junta conserva las decisiones e INDEX CONDO asume ejecución, seguimiento y rendición de cuentas. ¿Esto responde a la prioridad que definimos?", "Validar encaje entre problema y solución.", "reunion"),
  ...
  speech("propuesta-enviada-recepcion", "propuesta_enviada", "Confirmación de recepción", "Hola, [Nombre]. Quisiera confirmar que recibió correctamente la propuesta preparada para [Condominio] y saber si pudo abrir el documento. ¿Hay alguna persona adicional de la junta a quien debamos incluir en la revisión?", "Confirmar recepción y participantes.", "whatsapp"),
  speech("propuesta-enviada-revision", "propuesta_enviada", "Revisión guiada", "La propuesta resume el diagnóstico, la solución recomendada, el alcance y los honorarios. Para evitar que queden dudas fuera de contexto, sugiero revisarla juntos durante 20 minutos. ¿Qué día le conviene?", "Agendar revisión de propuesta.", "llamada"),
  speech("propuesta-enviada-inquietudes", "propuesta_enviada", "Detección temprana de inquietudes", "Después de revisar la propuesta, ¿qué aspecto considera más sólido y cuál necesitaría mayor explicación antes de presentarlo a la junta? Queremos resolver cualquier inquietud antes de la decisión.", "Identificar objeciones y siguiente decisión.", "reunion"),
