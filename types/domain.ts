...
export interface Communication { id: string; opportunityId: string; proposalId?: string; stakeholderId?: string; channel: "email" | "whatsapp"; direction: "outbound" | "inbound"; fromAddress: string; toAddress: string; subject?: string; bodyText: string; templateKey?: string; provider?: string; providerMessageId?: string; attachmentFormat?: ProposalFileFormat; status: string; errorMessage?: string; sentAt?: string; deliveredAt?: string; openedAt?: string; createdAt: string; }
